...
/// @notice Solarray is a blazing-fast helper library for convenient Solidity dynamic arrays. Useful for writing foundry test cases that involve arrays.
/// @author solarray (https://github.com/evmcheb/solarray/blob/master/src/Solarray.sol)
library Solarray {
    function uint8s(
        uint8 a
